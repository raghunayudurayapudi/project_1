...
echo "<tr><td>".$row["P_id"]."</td><td>".$row["p_name"]."</td><td>".$row["Year_released"]."</td><td>".$row["awards"]."</td><td>".$row["rating"]."</td><td>$".$row["rent_price"]."</td><td>$"
		.$row["buy_price"]."</td>"."<td><a href='edit.php' target='_self' class='btn btn-primary'>Edit</a></td>"."<td><a href='delete.php' target='_self' class='btn btn-primary'>Delete</a></td>"."</tr>";
